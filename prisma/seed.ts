...
async function main() {
    ...
    data: [
      {
        ...
        restock_date: new Date("2024-12-01T00:00:00Z"),
      ...
      },
      {
        ...
        restock_date: new Date("2024-11-15T00:00:00Z"),
      ...
      },
      {
        ...
        restock_date: new Date("2024-11-20T00:00:00Z"),
      ...
      },
      {
        ...
        restock_date: new Date("2024-12-05T00:00:00Z"),
      ...
      },
      {
        ...
        restock_date: new Date("2024-11-25T00:00:00Z"),
  ...
  const transactions = await prisma.inventoryTransaction.createMany({
    data: [
      {
        id: 1,
        productId: 1,
      ...
      },
      {
        ...
        transactionType: "restock",
        quantity: 200,
        date: new Date("2024-10-02T10:30:00Z"),
        remarks: "Initial stock received from supplier.",
      },
      {
        id: 3,
        ...
        transactionType: "restock",
        quantity: 300,
        date: new Date("2024-10-03T11:15:00Z"),
        remarks: "Initial stock received from supplier.",
      },
      {
        id: 4,
        ...
        transactionType: "restock",
        quantity: 50,
        date: new Date("2024-10-04T12:45:00Z"),
        remarks: "Initial stock received from supplier.",
      },
      {
        id: 5,
        ...
        transactionType: "restock",
        quantity: 75,
        date: new Date("2024-10-05T13:30:00Z"),
        remarks: "Initial stock received from supplier.",
      },
      {
        id: 6,
        ...
        transactionType: "restock",
        quantity: 40,
        date: new Date("2024-10-06T14:00:00Z"),
        remarks: "Initial stock received from supplier.",
      },
      {
        id: 7,
        ...
        quantity: -20,
        date: new Date("2024-10-10T15:20:00Z"),
      ...
      },
      {
        ...
        transactionType: "sale",
        quantity: -50,
        date: new Date("2024-10-11T16:00:00Z"),
      ...
      },
      {
        ...
        transactionType: "sale",
        quantity: -10,
        date: new Date("2024-10-12T17:15:00Z"),
      ...
      },
      {
        ...
        quantity: -5,
        date: new Date("2024-10-13T18:45:00Z"),
        remarks: "Damaged items removed from stock.",
      },
    ],
  });

  console.log({ categories, suppliers, products, transactions });
}
